...
int lockDelay=6000; // lock stays open for 6 seconds.
int BuzzerPin = A5;
...
void VictoryTheme() {
// Victory theme
// C - 523.25Hz / 1046.60Hz
// Ab - 415.30Hz / 830.6Hz
// Bb - 466.16Hz / 932.33Hz
    tone(BuzzerPin, 523.25, S);
    delay(S);
    tone(BuzzerPin, 523.25, S);
    delay(S);
    tone(BuzzerPin, 523.25, S);
    delay(S);
    tone(BuzzerPin, 523.25, E+S);
    delay(E+S);
    tone(BuzzerPin, 415.30, E+S);
    delay(E+S);
    tone(BuzzerPin, 466.16, E+S);
    delay(E+S);
    tone(BuzzerPin, 523.25, S);
    delay(S);
    delay(S);
    tone(BuzzerPin, 466.16, S);
    delay(S);
    tone(BuzzerPin, 523.25, Q+E);
delay(lockDelay-2834);
    // total time 2834
}
...
void FailTheme() {
    tone(BuzzerPin,220.00,Q);
    delay(1+Q); //delay duration should always be 1 ms more than the note in order to separate them.
    tone(BuzzerPin,220.00,Q);
    delay(1+Q);
    tone(BuzzerPin,220.00,Q);
    delay(1+Q);
    tone(BuzzerPin,174.61,E+S);
    delay(1+E+S);
    tone(BuzzerPin,261.63,S);
    delay(1+S);
    tone(BuzzerPin,220.00,Q);
    delay(1+Q);
    tone(BuzzerPin,174.61,E+S);
